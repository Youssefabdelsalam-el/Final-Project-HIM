  ...
  return (
    <div dir="rtl" className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <ExamInfoCards title="تاريخ البداية" value="15/10/2026" label="10:00 AM" icon={IoCalendarOutline} bgColor="bg-green-50" iconBg="bg-green-100" iconColor="text-green-600" valueColor="text-green-600"/>
