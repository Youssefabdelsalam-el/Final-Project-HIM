  ...
  return (
    ...
    <dialog id="my_modal_5" className="modal">
            ...
            <div className='border border-gray-200 flex flex-col gap-6 p-6 rounded-xl bg-gray-50/50'>
                ...
                <div className='flex flex-col sm:flex-row items-stretch sm:items-center justify-start gap-3 pt-2 w-full'>
                    <button type="button" className='flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-xl transition-all cursor-pointer shadow-sm active:scale-95 text-sm w-full sm:w-auto'>
                        <RiSave3Line className='w-6 h-6' />
                    حفظ التغيرات
                    </button>
                    <form method="dialog">
                        <button className='cursor-pointer border border-gray-300 text-gray-700 hover:bg-gray-100 font-bold py-2.5 px-6 rounded-xl transition-all text-sm w-full sm:w-auto'>
                            إلغاء
                        </button>
                    </form>
                </div>
