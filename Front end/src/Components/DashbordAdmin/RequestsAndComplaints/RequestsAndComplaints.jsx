...
import FilterRC from './FilterRC'
import CardRC from './CardRC'
import { BiSolidMessageSquareDetail } from 'react-icons/bi'

export default function RequestsAndComplaints() {
  return (
                  ...
                  <div className='flex flex-col gap-3 sm:gap-4 min-w-0'>
                       <div className='flex items-center gap-3'>
                            <div className='text-blue-600 bg-blue-100 p-3 rounded-4xl'>
                              <BiSolidMessageSquareDetail className='w-7 h-7' />
                            </div>
                            <h1 className='text-xl sm:text-2xl md:text-[25px] font-bold'>الطلبات والشكاوي</h1>
                        </div>
